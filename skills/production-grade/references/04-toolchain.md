...
| **Agent infra** | Workspace orchestrator (org-shared package) · Runtime (containerised base image) · Persona OS (see [`01-stack-eras.md`](01-stack-eras.md) §"Workspace persona") |
