# 00 — Official Tailwind CSS v3 → v4 upgrade guide (canonical source)

> Verbatim copy of the official upgrade guide, bundled for offline/authoritative reference.
> Source: https://tailwindcss.com/docs/upgrade-guide  © Tailwind Labs.
